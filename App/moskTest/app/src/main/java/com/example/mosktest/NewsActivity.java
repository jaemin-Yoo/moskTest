...
public class NewsActivity extends AppCompatActivity {
    ...
    private static final String TAG="Mosk";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=YzjnflyDjy6vjQcWocp1eHCuvnz%2FrJLrbZOc72FZ6MbUY88H4YuwTBfl9k3WjTrQ1WGOhGltTiHytBB8cao0hQ%3D%3D"); /*Service Key*/
